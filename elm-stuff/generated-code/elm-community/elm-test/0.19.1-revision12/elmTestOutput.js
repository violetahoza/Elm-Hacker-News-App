...
var $author$project$Util$Time$durationBetween = F2(
	function (date1, date2) {
		var timeDifference = $elm$time$Time$posixToMillis(date2) - $elm$time$Time$posixToMillis(date1);
		var seconds = A2($elm$core$Basics$modBy, 60, (timeDifference / 1000) | 0);
		var minutes = A2($elm$core$Basics$modBy, 60, (timeDifference / (60 * 1000)) | 0);
		var hours = A2($elm$core$Basics$modBy, 24, (timeDifference / ((60 * 60) * 1000)) | 0);
	...
	function (value, unit) {
		switch (value) {
			case 0:
				return $elm$core$Maybe$Nothing;
			case 1:
				return $elm$core$Maybe$Just('1 ' + unit);
			default:
				return $elm$core$Maybe$Just(
					$elm$core$String$fromInt(value) + (' ' + (unit + 's')));
		}
	});
var $author$project$Util$Time$formatDuration = function (duration) {
	var components = A2(
		$elm$core$List$map,
		function (m) {
			return A2($elm$core$Maybe$withDefault, '', m);
		},
		A2(
			$elm$core$List$filter,
			function (component) {
				return !_Utils_eq(component, $elm$core$Maybe$Nothing);
			},
			_List_fromArray(
				[
					A2($author$project$Util$Time$formatComponent, duration.days, 'day'),
					A2($author$project$Util$Time$formatComponent, duration.hours, 'hour'),
					A2($author$project$Util$Time$formatComponent, duration.minutes, 'minute'),
					A2($author$project$Util$Time$formatComponent, duration.seconds, 'second')
				])));
	if (!components.b) {
		return 'just now';
	} else {
		return A2($elm$core$String$join, ' ', components) + ' ago';
	}
};
...
var $author$project$Model$PostsConfig$ChangeShowTextOnlyPost = function (a) {
	return {$: 'ChangeShowTextOnlyPost', a: a};
};
							...
							[
								...
								_List_fromArray(
									[
										...
										$elm$html$Html$Attributes$selected(configuration.postsToShow === 10)
									]),
								_List_fromArray(
									[
								...
								_List_fromArray(
									[
										...
										$elm$html$Html$Attributes$selected(configuration.postsToShow === 25)
									]),
								_List_fromArray(
									[
								...
								_List_fromArray(
									[
										...
										$elm$html$Html$Attributes$selected(configuration.postsToShow === 50)
									]),
								_List_fromArray(
									[
								...
								return A2(
									...
									_List_fromArray(
										[
											...
											_Utils_eq(configuration.sortBy, sort))
										]),
									_List_fromArray(
										[
											$elm$html$Html$text(
					...
					[
						...
						_List_fromArray(
							[
								...
								$elm$html$Html$Attributes$checked(configuration.showJobs),
								$elm$html$Html$Events$onCheck(
								function (isChecked) {
									return $author$project$Model$ConfigChanged(
										$author$project$Model$PostsConfig$ChangeShowJobPosts(isChecked));
								})
							]),
						_List_Nil)
					])),
					...
					[
						...
						_List_fromArray(
							[
								...
								$elm$html$Html$Attributes$type_('checkbox'),
								$elm$html$Html$Attributes$checked(configuration.showTextOnly),
								$elm$html$Html$Events$onCheck(
								function (isChecked) {
									return $author$project$Model$ConfigChanged(
										$author$project$Model$PostsConfig$ChangeShowTextOnlyPost(isChecked));
								})
							]),
						_List_Nil)
					]))
			...
			case 'FailedToLoad':
				...
				return A2(
					...
					_List_fromArray(
						[
							$elm$html$Html$text(
							'Failed to load: ' + $elm$core$Debug$toString(err))
						]));
			case 'LoadedPosts':
	...
	if (!left.b) {
		...
		return $elm$core$Maybe$Just(
			A3(
				...
				xs,
				x,
				A2($elm$core$List$cons, el, right)));
	}
};
var $author$project$Cursor$length = function (_v0) {
	var left = _v0.a;
	var right = _v0.c;
	return ($elm$core$List$length(left) + $elm$core$List$length(right)) + 1;
};
...
var $author$project$Test$Generated$Main$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		...
		paths: _List_fromArray(
			['C:\\Users\\hozas\\OneDrive\\De toate\\facultate\\FP\\Elm-Project\\tests\\ExampleTests\\CursorTests.elm', 'C:\\Users\\hozas\\OneDrive\\De toate\\facultate\\FP\\Elm-Project\\tests\\ExampleTests\\ModelPostIdsTests.elm', 'C:\\Users\\hozas\\OneDrive\\De toate\\facultate\\FP\\Elm-Project\\tests\\ExampleTests\\ModelPostsConfigTests.elm', 'C:\\Users\\hozas\\OneDrive\\De toate\\facultate\\FP\\Elm-Project\\tests\\ExampleTests\\UtilTimeTests.elm', 'C:\\Users\\hozas\\OneDrive\\De toate\\facultate\\FP\\Elm-Project\\tests\\MainTests.elm', 'C:\\Users\\hozas\\OneDrive\\De toate\\facultate\\FP\\Elm-Project\\tests\\PostsConfigTests.elm', 'C:\\Users\\hozas\\OneDrive\\De toate\\facultate\\FP\\Elm-Project\\tests\\PostsViewTests.elm', 'C:\\Users\\hozas\\OneDrive\\De toate\\facultate\\FP\\Elm-Project\\tests\\PostTests.elm', 'C:\\Users\\hozas\\OneDrive\\De toate\\facultate\\FP\\Elm-Project\\tests\\SimulatedEffect.elm', 'C:\\Users\\hozas\\OneDrive\\De toate\\facultate\\FP\\Elm-Project\\tests\\TestData.elm', 'C:\\Users\\hozas\\OneDrive\\De toate\\facultate\\FP\\Elm-Project\\tests\\TestUtils.elm']),
		processes: 22,
